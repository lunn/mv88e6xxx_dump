...
static void ports_print(struct mv88e6xxx_ctx *ctx, int ports)
{
	int port, reg;
...
static void ports(struct mv88e6xxx_ctx *ctx)
{
	int port;
	int err;
...
static void atu(struct mv88e6xxx_ctx *ctx)
{
	int err;
...
static void vtu(struct mv88e6xxx_ctx *ctx)
{
	int err;
...
static void global1(struct mv88e6xxx_ctx *ctx)
{
	uint16_t *g2;
        int err;
	int i;
...
static void global2(struct mv88e6xxx_ctx *ctx)
{
	uint16_t *g2;
        int err;
	int i;
